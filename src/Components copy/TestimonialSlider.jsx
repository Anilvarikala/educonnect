  ...
  const testimonials = [
    {
      ...
      review:
        "Educonnect has been a game changer for my career. The resources are well-organized, and the platform makes learning easy and enjoyable.",
    ...
    },
    {
      ...
      review:
        "As an intermediate student, Educonnect helped me strengthen my skills. The content is well-structured, and the community support is fantastic.",
      image: "https://via.placeholder.com/100",
    },
    {
      name: "Anil",
      role: "Developer",
      review:
        "I love how Educonnect provides real-world resources that align with industry standards. The learning paths are very practical and helpful.",
      image: "https://via.placeholder.com/100",
    },
    {
      name: "Sara Lee",
      role: "Designer",
      review:
        "Educonnect is a one-stop solution for learning. Whether you're a beginner or intermediate, the platform has something for everyone.",
      image: "https://via.placeholder.com/100",
    },
  ];
